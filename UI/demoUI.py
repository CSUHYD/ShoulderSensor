...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btnOpenPlotDialog = QPushButton(self.horizontalLayoutWidget_3)
        self.btnOpenPlotDialog.setObjectName(u"btnOpenPlotDialog")
        self.btnOpenPlotDialog.setFont(font)

        self.horizontalLayout_3.addWidget(self.btnOpenPlotDialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btnOpenPlotDialog.setText(QCoreApplication.translate("Dialog", u"\u7ed8\u56fe", None))
